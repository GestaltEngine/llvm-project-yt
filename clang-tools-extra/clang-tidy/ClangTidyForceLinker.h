...
// This anchor is used to force the linker to link the YTModule.
extern volatile int YTModuleAnchorSource;
[[maybe_unused]] static int YTModuleAnchorDestination =
    YTModuleAnchorSource;
